...
var player1 = GetUrlValue('playerOne');
var player2 = GetUrlValue('playerTwo');
...
function initializeGame()
{
    ...
    // scoreCard.innerHTML = "<div id='restart_game' onclick='restartGame(); return false;' class='btn btn-lg btn-block btn-primary'>Start New Game</div>";
...
function changeOrientation()
{
    ...
    if(ORIENTATION) {
        ...
        document.getElementById("whosturn").style.top = "50px";
...
{            
    ...
    if(WHOS_TURN_IS_IT == BLACK) {
        document.getElementById("whosturn").innerHTML = player1 + "'s Turn";
        document.getElementById("whosturn").style.color = WHOS_TURN_IS_IT;
    } else if(WHOS_TURN_IS_IT == RED) {
        document.getElementById("whosturn").innerHTML = player2 + "'s Turn";
        document.getElementById("whosturn").style.color = WHOS_TURN_IS_IT;
    }
